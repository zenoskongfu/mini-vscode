...
export function FileTreeNode({
  ...
  const menuItems: ContextMenuEntry[] = node.isDirectory
    ? [
        ...
        { separator: true },
        { label: 'Rename',     onClick: () => { setRenaming(true); setRenameValue(node.name) } },
...
function FolderIcon(): React.JSX.Element {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M1 3.5C1 2.67 1.67 2 2.5 2H6l1.5 2H13.5C14.33 4 15 4.67 15 5.5v7c0 .83-.67 1.5-1.5 1.5h-11C1.67 14 1 13.33 1 12.5v-9z"
        fill="#dcb67a" />
    </svg>
  )
}
...
function FolderOpenIcon(): React.JSX.Element {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M1 3.5C1 2.67 1.67 2 2.5 2H6l1.5 2H13.5C14.33 4 15 4.67 15 5.5V7H1V3.5z"
        fill="#dcb67a" />
      <path d="M1 7h14l-1.5 7h-11L1 7z"
        fill="#e8c47e" />
    </svg>
  )
}
